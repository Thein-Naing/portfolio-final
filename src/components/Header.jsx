...
export const Header = () => {
  return (
    <header className='header'>
      ...
      I am looking for an oppotunity to apply these skills as an entry level software developer for meaningful projects with dedicated professional software developers.
      </p>
      <Link to="/skills"
